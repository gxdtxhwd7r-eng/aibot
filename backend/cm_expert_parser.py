...
ALIASES: dict[str, set[str]] = {
    ...
    "pts": {"птс", "тип птс"},
    "owners": {"количество владельцев", "владельцев", "владельцы", "владельцев по птс"},
    "seller_type": {"тип продавца", "продавец тип", "продавец"},
    "seller_name": {"имя продавца", "контактное лицо"},
    "city": {"город", "регион город", "местоположение", "населенный пункт"},
    "description": {
        "комментарий описание продавца",
        "комментарий продавца",
        "комментарий продавца на классифайде",
        "описание продавца",
        "описание",
        "комментарий",
    },
    "auto_url": {"ссылка auto ru", "auto ru", "ссылка на auto ru", "autor u"},
    "avito_url": {"ссылка avito", "avito", "avito ru", "ссылка на avito"},
    "drom_url": {"ссылка drom", "drom", "drom ru", "ссылка на drom"},
    "cm_url": {
        "ссылка cm expert",
        "cm expert",
        "ссылка в cm expert",
    ...
    "photos": {
        ...
        "количество фотографий в объявлении с минимальной ценой",
        "фото",
        "кол во фото",
    },
}
