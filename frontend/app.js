...
async function loadLeads() {
  try {
    ...
    document.querySelectorAll('[data-copy]').forEach(button=>button.onclick=()=>navigator.clipboard.writeText(data.items.find(item=>item.id===Number(button.dataset.copy)).message));
